...
** Requirements
   ...
   - PyTorch 1.5
   - pillow
*Notes*: The versions Python and PyTorch must be v3.6 and v1.5. If you
use Python3.7+, some module can not be correctly loaded; if you use
PyTorch with other versions, some errors may be caused.
** Test
